...
const ONBOARDING_KEY = 'jobapply_onboarded';
...
function showOnboardingWizard() {
    ...
    function renderStep2() {
        return `
            ...
            <p class="onboarding-desc">Upload your master resume so JobApply can populate your profile fields. You can edit everything in Settings afterward.</p>
    ...
    function renderStep3() {
        return `
            ...
            <p class="onboarding-desc"><strong>Recommended:</strong> Ollama (local). Cloud providers send profile data and form field labels to that provider when autofill runs.</p>
            <div class="onboarding-form">
                <div class="onboarding-field">
                    <label for="onb-provider">Provider</label>
                    <select id="onb-provider" class="filter-select" style="width:100%">
                        <option value="">Select a provider...</option>
                        <option value="ollama" selected>Ollama (Local — recommended)</option>
