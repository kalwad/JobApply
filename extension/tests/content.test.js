...
describe('sanitizeMappings / getNearbyHeading', () => {
  it('drops phone-like values on non-phone fields', () => {
    const cleaned = api.sanitizeMappings([
      { selector: '#phone', field_label: 'Phone', value: '2488322855', action: 'fill_text', confidence: 1 },
      { selector: '#gpa', field_label: 'What is your current cumulative GPA?', value: '2488322855', action: 'fill_text', confidence: 0.9 },
      { selector: '#why', field_label: 'Why are you interested?', value: '2488322855', action: 'fill_text', confidence: 0.9 },
